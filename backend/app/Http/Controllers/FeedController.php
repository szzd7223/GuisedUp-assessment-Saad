...
class FeedController extends Controller
{
    ...
    public function search(Request $request) { $data = $request->validate(['q' => ['required', 'string', 'max:500']]); return response()->json(['data' => $this->ranking->search($data['q'], $request->user())]); }
